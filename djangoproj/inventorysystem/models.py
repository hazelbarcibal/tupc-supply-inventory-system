...
class requestequipment(models.Model):
    ...
    request_equipment_unit = models.CharField(default="",max_length=50, verbose_name='request_equipment_brand')
    request_equipment_quantity = models.DecimalField(max_digits=6, decimal_places=0, verbose_name='request_equipment_quantity')
    request_equipment_unitcost = models.DecimalField(default=0, max_digits=6, decimal_places=0, verbose_name='request_equipment_unitcost')
    ...
    request_equipment_iin = models.CharField(default="",max_length=50, blank=True, verbose_name='request_equipment_iin')
