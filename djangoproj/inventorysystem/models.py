...
class CustomUser(AbstractUser):
    ...
    adminRole = models.CharField(max_length=25, verbose_name='adminRole', default='')
...
class deliverysupply(models.Model):
    ...
    delivery_supply_unit = models.CharField(max_length=50, choices=UNITS, verbose_name='delivery_supply_unit')
