# Generated by Django 3.2.15 on 2022-11-09 17:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='equipment_storagemapping',
            fields=[
                ('equipmentStoragemapping_id', models.AutoField(primary_key=True, serialize=False)),
                ('equipmentItemName', models.CharField(max_length=50, verbose_name='Equipment ItemName')),
                ('equipmentRackNo', models.CharField(max_length=50, null=True, verbose_name='Equipment Rack')),
                ('equipmentLayerNo', models.DecimalField(decimal_places=0, max_digits=6, null=True, verbose_name='Equipment Layer')),
                ('equipmentCabinetNo', models.DecimalField(decimal_places=0, max_digits=6, null=True, verbose_name='Equipment Cabinet')),
                ('equipmentShelfNo', models.DecimalField(decimal_places=0, max_digits=6, null=True, verbose_name='Equipment Shelf')),
            ],
            options={
