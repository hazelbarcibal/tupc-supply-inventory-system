    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('withdraw_supplyRackNo', models.CharField(max_length=50, null=True, verbose_name='Supply Rack')),
                ('withdraw_supplyLayerNo', models.DecimalField(decimal_places=0, max_digits=6, null=True, verbose_name='Supply Layer')),
                ('withdraw_supplyCabinetNo', models.DecimalField(decimal_places=0, max_digits=6, null=True, verbose_name='Supply Cabinet')),
                ('withdraw_supplyShelfNo', models.DecimalField(decimal_places=0, max_digits=6, null=True, verbose_name='Supply Shelf')),
                ('current_date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='withdraw_current_date')),
            ],
        ),
        migrations.CreateModel(
